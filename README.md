...
2. Optional: open the job page in your browser and click **Get Apply URL** to copy the link, screenshot the page, and auto-fill blank company/title/URL fields. Or paste the job posting text and press **Fill Blanks**.
